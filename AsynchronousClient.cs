    ...
    public static class AsynchronousClient
    {
        ...
        public static void StartClient()
        {
            ...
            try
            {
                ...
                while (true)
                {
                    //Read message typed into console
        ...
        {
            //write all responses from BLE server into csv
            File.AppendAllText("EDA.csv", response);
            //Write all responses from empatica BLE server into console
